<template>
    <b-form role="form" @submit.prevent="onSubmit">
        ...
        <b-row>
            <b-col>
                <b-form-group id="input-group-4" label="Change File:" label-for="input-2">
                    <b-form-checkbox id="input-4" placeholder="Select a File" v-model="changeFile">
                        <template #default>
                            <span>{{getFileName(form.image)}}</span>
                        </template>
                    </b-form-checkbox>
                </b-form-group>

            </b-col>
            <b-col v-if="changeFile">
        ...
        <b-row>
            <b-col>
                <b-form-group id="input-group-2" label="Amount:" label-for="input-2">
                    <b-form-input id="input-2" placeholder="Enter amount" type="number"
                        v-model="form.selling_price" required></b-form-input>
                </b-form-group>
            </b-col>

            <b-col>
                <b-form-group id="input-group-2" label="Stock:" label-for="input-3">
    ...
    methods : {
        ...
        onSubmit () {
            ...
            axios.form(urls.admin.product.addEdit, that.form).then(function (response) {
                ...
                that.loading = false;
                console.log('exception occurred at the edit of product : ', exception);
